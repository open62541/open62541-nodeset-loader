...
Value *BackendOpen62541_Value_new(const TNode *node)
{
    ...
    UA_NodeId dataTypeId = getNodeIdFromChars(((const TVariableNode *)node)->datatype);
...
static void setBoolean(uintptr_t adr, char *value) { *(UA_Boolean *)adr = isTrue(value); }
...
static void setInt32(uintptr_t adr, char *value) { *(UA_Int32 *)adr = atoi(value); }

static void setUInt32(uintptr_t adr, char *value) {
    *(UA_UInt32 *)adr = (UA_UInt32)atoi(value);
}

static void setInt64(uintptr_t adr, char *value) { *(UA_Int64 *)adr = atoi(value); }
...
static void setDouble(uintptr_t adr, char *value) { *(UA_Double *)adr = atof(value); }
